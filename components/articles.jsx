...
const Articles = ({ articles }) => {
  const latestAticle = articles.slice(-1);
  ...
  return (
    <div>
      ...
      <section className="section bubble bg-green-400" id="two">
        <div className="container mx-auto">
          ...
          <div className="absolute top-[50%] right-10 -rotate-90 font-bold text-9xl opacity-70 family-bold tracking-widest text-white">
            Tech
          </div>
        </div>
        <div className="wave">
